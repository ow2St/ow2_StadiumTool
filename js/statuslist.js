...
addStatusList("オリーサ",300,0,325,"フュージョンドライバー改",14,"-",3,49,2,"なし",0,"-",0,0,1,"エネルギージャベリン",110,"70+40(壁)",0,6,"フォーティファイ",100,"-",4,0,"ジャベリンスピン",100,"20+5.33…*15",1.75,8,"テラサージ",571.4,"1.5*2+3.6*19+500",4,40);
...
addStatusList("ジャンカー・クイーン",525,0,0,"スキャッターガン",80,"8*10",1.5,8,2,"なし",0,"-",0,0,1,"ギザギザブレード",35.08,"5+2.4+1.92*14+0.8",3,6,"コマンディングシャウト",200,"-",5,12,"カーネイジ","144.89","105+3.2+2.56*14+0.85",3,8,"ランペイジ",129.92,"3.84*33+3.2",4.5,54.96);
...
addStatusList("アッシュ",250,0,0,"ザヴァイパー・ADS",75,"-",0.25,12,2,"ザヴァイパー・腰撃ち",35,"-",0.25,12,2,"コーチガン",60,"6*15",0,10,"ダイナマイト",150,"50+3.84*26+0.16",5,12,"なし",0,"-",0,0,"BOB",1446,"120+17*78",10,40);
...
addStatusList("リーパー",300,0,0,"ヘルファイアショットガン",108,"21.6*5",1.5,8,2,"なし",0,"-",0,0,1,"シャドウステップ",0,"-",0,10,"レイスフォーム",0,"-",3,8,"なし",0,"-",0,0,"デスブロッサム",555,"37*15",3,40);
...
addStatusList("アナ",250,0,0,"バイオティックライフル",75,"2.4+7.2+28.8*2+7.8",1.5,15,2,"なし",0,"-",0,0,1,"スリープダーツ",5,"-",5,14,"バイオティックグレネード",75,"-",3,14,"なし",0,"-",0,0,"ナノブースト",250,"-",8,40);
...
addStatusList("マーシー",225,0,0,"カデュケウススタッフ",60,"-",0,0,1,"カデュケウスブラスター",20,"-",1.4,25,2,"ガーディアンエンジェル",0,"-",0,1.5,"リザレクト",0,"-",1.75,30,"なし",0,"-",0,0,"ヴァルキリー",20,"-",15,40);
