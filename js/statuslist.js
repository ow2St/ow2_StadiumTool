...
addStatusList("DVA（メック）",375,0,325,"フュージョンキャノン",22,"2*11",0,0,"なし",0,"-",0,0,"ブースター",25,"-",2,3.5,"ディフェンスマトリックス",0,"-",3,6,"マイクロミサイル",153,"8.5*18",1.6,7,"自爆",1000,"-",3);
addStatusList("DVA（人）",175,0,0,"ライトガン",14,"-",1.4,20,"なし",0,"-",0,0,"なし",0,"-",0,0,"なし",0,"-",0,0,"なし",0,"-",0,0,"メック召喚",250,"-",0);
addStatusList("オリーサ",300,0,325,"フュージョンドライバー改",14,"-",3,49,"なし",0,"-",0,0,"エネルギージャベリン",110,"70+40(壁)",0,6,"フォーティファイ",100,"-",0,0,"ジャベリンスピン",100,"20+5.33…*15",1.75,8,"テラサージ",571.4,"1.5*2+3.6*19+500",4);
...
addStatusList("ジャンカー・クイーン",525,0,0,"スキャッターガン",80,"8*10",1.5,8,"なし",0,"-",0,0,"ギザギザブレード",35.08,"5+2.4+1.92*14+0.8",3,6,"コマンディングシャウト",200,"-",5,12,"カーネイジ","144.89","105+3.2+2.56*14+0.85",3,8,"ランペイジ",129.92,"3.84*33+3.2",4.5);
...
addStatusList("シグマ",350,275,0,"ハイパースフィア",55,"-",0,0,"なし",0,"-",0,0,"キネティックグラスプ",400,"X*0.6",2,12,"アクリーション",120,"-",1.1,10,"エクスペリメンタルバリア",700,"-",0,5,"グラビティフラックス",50,"50+HP50%",7);
...
addStatusList("キャスディ",275,0,0,"ピースキーパー・単発",70,"-",1.5,6,"ピースキーパー・連射",50,"-",1.5,6,"コンバットロール",0,"-",0.4,6,"フラッシュバン",75,"-",0.9,12,"なし",0,"-",0,0,"デッドアイ",1800,"150*2+300*5",7);
addStatusList("ゲンジ",250,0,0,"手裏剣・バースト",27,"-",1.5,24,"手裏剣・散弾",27,"-",1.5,24,"木の葉返し",0,"-",2,8,"風斬り",50,"-",0.4,6,"なし",0,"-",0,0,"竜撃剣",110,"-",6);
addStatusList("ソルジャー76",250,0,0,"ヘビーパルスライフル",19,"-",1.5,30,"なし",0,"-",0,0,"スプリント",0,"-",0,0,"バイオティックフィールド",200,"40*5",5,15,"ヘリックスロケット",120,"-",0,6,"タクティカルバイザー",19,"-",6);
...
addStatusList("メイ",250,0,0,"凍結ブラスター・スプレー",5,"-",1.5,140,"凍結ブラスター・つらら",85,"-",1.5,140,"クリオフリーズ",250,"62.5*4",4,12,"アイスウォール",250,"-",5,12,"なし",0,"-",0,0,"ブリザード",85.12,"4.48+3.84*21",4.25);
...
addStatusList("ジャンクラット",250,0,0,"フラグランチャー",125,"-",1.5,5,"なし",0,"-",0,0,"コンカッションマイン",120,"-",0,7,"スティールトラップ",100,"-",2.5,10,"なし",0,"-",0,0,"RIPタイヤ",600,"-",10);
...
addStatusList("キリコ",225,0,0,"快気の御札",26,"-",0.9,10,"クナイ",60,"-",1,15,"神出鬼没",0,"-",0.25,8,"鈴のご加護",80,"-",0.65,15,"なし",0,"-",0,0,"狐走り",0,"-",0);
addStatusList("ジュノ",75,150,0,"メディブラスター",90,"7.5*12",1.5,180,"なし",0,"-",0,0,"パルサートーピード",85,"-",0,10,"グライドブースト",0,"-",5,6,"ハイパーリング",0,"-",3.5,14,"オービタルレイ",680,"85*8",8);
addStatusList("マーシー",225,0,0,"カデュケウススタッフ",60,"-",0,0,"カデュケウスブラスター",20,"-",1.4,25,"ガーディアンエンジェル",0,"-",0,1.5,"リザレクト",0,"-",1.75,30,"なし",0,"-",0,0,"ヴァルキリー",20,"-",15);
addStatusList("モイラ",225,0,0,"バイオティックグラスプ・回復",70,"-",0,0,"バイオティックグラスプ・吸収",65,"-",0,0,"バイオティックオーブ",200,"-",7,8,"フェード",0,"-",1,6,"なし",0,"-",0,0,"コアレッセンス",680,"-",8);
addStatusList("ルシオ",225,0,0,"ソニックアンプリファイア",88,"22*4",1.25,20,"なし",0,"-",0,0,"クロスフェード",16,"-",0,0,"アンプイットアップ",52,"-",3,12,"サウンドウェーブ",45,"-",0,4,"サウンドバリア",3740,"-",7);
addStatusList("ゼニヤッタ",75,175,0,"破滅のオーブ・単発",50,"-",1.5,25,"破滅のオーブ・溜め",250,"50*5",1.5,25,"不和のオーブ",0,"-",1.5,6,"調和のオーブ",30,"-",5,0,"なし",0,"-",0,0,"心頭滅却",300,"-",6);
